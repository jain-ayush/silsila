  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold uppercase tracking-widest">Add New Jewellery</h1>
      </div>
          ...
          <div className="bg-white p-6 border space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <CldUploadWidget 
                ...
                signatureEndpoint="" // Forces unsigned if using uploadPreset
                options={{
                  maxFiles: 5,
          ...
          <div className="bg-white p-6 border space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Select onValueChange={(val: string | null) => setFormData({ ...formData, categoryId: val ?? "" })}>
